...
/**
 * Community vless:// lines for whitelist-only pool (Dahusim [WhitelistBuiltinVlessShareLines]).
 */
object VolkvnBuiltinVlessShareLines {

    const val WL_VLESS_NAME_PREFIX = "WL vless #"
