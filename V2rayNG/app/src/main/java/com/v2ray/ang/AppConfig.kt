...
object AppConfig {
    ...
    const val PREF_VOLKVN_BATTERY_OPT_PROMPTED = "pref_volkvn_battery_opt_prompted_v1"
    ...
    // Non-Google fallback for regions/providers where Google endpoints are blocked or reset.
